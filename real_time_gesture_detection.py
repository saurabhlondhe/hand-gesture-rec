...
while camera.isOpened():
    ...
    if k == 27:  # press ESC to exit all windows at any time
        ...
        if save_images:
            img_name = "./frames/drawings/drawing_"+prediction+"_"+str(img_counter)+".jpg"
            cv2.imwrite(img_name, drawing)
            print("written")

            img_name2 = "./frames/silhouettes/"+prediction+"_"+str(img_counter)+".jpg"
            cv2.imwrite(img_name2, thresh)
            print("written")

            img_name3 = "./frames/masks/mask_"+prediction+"_"+str(img_counter)+".jpg".format(
                img_counter)
